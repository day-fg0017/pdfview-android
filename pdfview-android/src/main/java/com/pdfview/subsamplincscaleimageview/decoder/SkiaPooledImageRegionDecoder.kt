...
import com.pdfview.subsamplincscaleimageview.SubsamplingScaleImageView.Companion.preferredBitmapConfig
import java.io.File
...
class SkiaPooledImageRegionDecoder(bitmapConfig: Bitmap.Config?) : ImageRegionDecoder {
    ...
    init {
        this.bitmapConfig = bitmapConfig ?: (preferredBitmapConfig ?: Bitmap.Config.RGB_565)
    }
    ...
    override val isReady: Boolean
         ...
         */
        get() = decoderPool != null && decoderPool?.isEmpty == false
    ...
    companion object {
        private val TAG: String = SkiaPooledImageRegionDecoder::class.java.simpleName
